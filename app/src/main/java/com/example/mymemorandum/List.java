package com.example.mymemorandum;
                        ...
                        .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                if(cursor.moveToFirst()){
                                    ...
                                    cursor.close();
                                    //oast.makeText(List.this,"success",Toast.LENGTH_SHORT).show();
                                }
                                ArrayAdapter<String> adapter=new ArrayAdapter<String>(List.this,R.layout.support_simple_spinner_dropdown_item,date);
                                ListView listView=(ListView)findViewById(R.id.list_view);
                                listView.setAdapter(adapter);
                            }
                        }).setNegativeButton("取消",null).show();
//                Intent intent = new Intent(List.this, CheckActivity.class);//实现点击菜单选项启动相应活动
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(List.this,"add success",Toast.LENGTH_SHORT).show();
                Cursor cursor=db.query("memo",null,null,null,null,null,null);
                date.add(count++,a);
                ArrayAdapter<String> adapter=new ArrayAdapter<String>(List.this,R.layout.support_simple_spinner_dropdown_item,date);
                ListView listView=(ListView)findViewById(R.id.list_view);
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case 2:
                ...
                date.set(MID,yy);
                ArrayAdapter<String> adapter1=new ArrayAdapter<String>(List.this,R.layout.support_simple_spinner_dropdown_item,date);
            ...
            case 3:
                ...
                date.set(MID,yyy);
                ArrayAdapter<String> adapter2=new ArrayAdapter<String>(List.this,R.layout.support_simple_spinner_dropdown_item,date);
